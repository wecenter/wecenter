...
class js extends AWS_CONTROLLER
{
	...
	public function last_questions_action()
	{
		...
		echo $this->model('k2_external')->format_js_question_output($_GET['ul_class'], $this->model('question')->get_questions_list(null, $_GET['limit'], 'new', $_GET['topic_ids'], $_GET['category_id'], null, $_GET['day']));
	}
