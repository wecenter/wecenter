...
class main extends AWS_CONTROLLER
{
	...
	{
		if (preg_match('/playstation/i', strtolower($_SERVER['HTTP_USER_AGENT'])) OR preg_match('/ipad/i', strtolower($_SERVER['HTTP_USER_AGENT'])) OR preg_match('/ucweb/i', strtolower($_SERVER['HTTP_USER_AGENT'])))
		{
			HTTP::redirect('/');
		}
