...
class js extends AWS_CONTROLLER
{
	...
	public function last_questions_action()
	{
		...
		echo $this->model('aws_offical_external')->format_js_question_output($this->model('question')->get_questions_list(1, intval($_GET['limit']), 'new', $_GET['topic_ids'], $_GET['category_id'], null, $_GET['day']));
	}
