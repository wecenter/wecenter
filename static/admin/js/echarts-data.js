$(function () {
    var echart = new Echarts('#main', 'line', 'http://192.168.0.100/wecenter/?/admin/ajax/statistic/?tag=new_question_by_month,new_answer_by_month&start_date=2012-01&end_date=2012-12');
    var echart2 = new Echarts('#main2', 'line', 'http://192.168.0.100/wecenter/?/admin/ajax/statistic/?tag=user_register_by_month,new_answer_by_month,new_question_by_month,new_topic_by_month&start_date=2013-01&end_date=2013-12');
    var echart3 = new Echarts('#main3', 'line', 'http://192.168.0.100/wecenter/?/admin/ajax/statistic/?tag=user_register_by_month,new_answer_by_month,new_question_by_month,new_topic_by_month&start_date=2014-01&end_date=2014-12');
});
