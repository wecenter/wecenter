...
//登陆背景图轮播
var logPicture = [
		{url:G_STATIC_URL + '/common/login_01.jpg',txt:'欢迎来到 Anwsion 问答社区，<br/>你想知道的一切，或许答案都在这里。<br/><span class="i_cl_05">1.1 正式版发布！</span>'},
		{url:G_STATIC_URL + '/common/login_02.jpg',txt:'庆祝 Anwsion 1.1 版本发布！'},
		{url:G_STATIC_URL + '/common/login_03.jpg',txt:'Anwsion 是一个新型的社区建站程序，包括了问答，维基，以及社交等丰富而又轻量化的功能。<br/><span class="i_cl_05">这将是您的最好选择！</span>'}
];
