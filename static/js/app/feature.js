function get_hot_posts(day)
{
	...
	$.get(G_BASE_URL + '/explore/ajax/list/sort_type-hot__feature_id-' + FEATURE_ID + '__day-' + day + '__per_page-5', function (response)
	{
		if ($.trim(response) != '')
		{
...
$(document).ready(function () {
	$('#feature_dynamic a').click(function ()
	{
		...
		{
			bp_more_load(G_BASE_URL + '/explore/ajax/list/sort_type-unresponsive__per_page-10__feature_id-' + FEATURE_ID, $('#bp_all_more'), $('#c_all_list'), 1);
		}
		else
		{
			bp_more_load(G_BASE_URL + '/explore/ajax/list/sort_type-new__feature_id-' + FEATURE_ID, $('#bp_all_more'), $('#c_all_list'), 1);
		}
	});
