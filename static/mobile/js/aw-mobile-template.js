				...
				'<div class="modal-content">'+
				    '<form action="' + G_BASE_URL + '/publish/ajax/publish_question/" method="post" id="quick_publish" onsubmit="return false">'+
						    ...
						    '<div class="aw-publish-title clearfix" id="quick_publish_category_chooser">'+
							    '<div class="aw-publish-dropdown">'+
							    	'<p data-toggle="dropdown" class="dropdown-toggle">'+
							    		'<span class="pull-left text-color-999">' + _t('选择分类') + '</span>'+
							    		'<i class="pull-left"></i>'+
							    	'</p>'+
							    '</div>'+
					    	'</div>'+
					    ...
					    '<div class="modal-footer">'+
					    	...
					    	'<button class="btn btn-primary btn-primary" onclick="AWS.ajax_post($(\'#quick_publish\'), AWS.ajax_processer, \'quick_publish\'); return false;">' + _t('发起') + '</button>'+
					    '</div>'+
				    '</form>'+
				'</div>'+
			'</div>'+
		   ...
		   '<div class="modal-dialog">'+
				'<div class="modal-content">'+
				   '<form id="publish" action="' + G_BASE_URL + '/inbox/ajax/send/" method="post" id="quick_publish" onsubmit="return false">'+
					    ...
					    '<div class="modal-footer">'+
					    	'<a data-dismiss="modal" aria-hidden="true">' + _t('取消') + '</a>'+
					    	'<button class="btn btn-primary" onclick="AWS.ajax_post($(\'#publish\'))">' + _t('发送') + '</button>'+
					    '</div>'+
				    '</form>'+
				'</div>'+
			'</div>'+
