...
{	
	...
	{
		AWS_APP::session()->admin_login = H::encode_hash(array('uid' => $uid, 'UA' => $_SERVER['HTTP_USER_AGENT'], 'ip' => $_SERVER['REMOTE_ADDR']));
	}
	...
	{
		$cache_key = 'user_actions_' . md5($uid . $limit . $actions . $this_uid . $distint);
