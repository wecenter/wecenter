		...
		foreach ($data AS $key => $val)
		{
			...
			if ($val['extend_count'])
			{
				...
				{					
					...
					if ($action_type == self::TYPE_ANSWER_AT_ME)
					{
						$data[$key]['extend_message'][] = AWS_APP::lang()->_t('他们在回答中提到了你') . ': ' . $users_list;
					}
					else if ($action_type == self::TYPE_COMMENT_AT_ME)
					{
