...
TPL::assign('page_title', 'Anwsion - Install');
...
switch ($_POST['step'])
{
	...
	case 3 :
		...
		{
			H::redirect_msg(load_class('core_lang')->_t('安装中止: Anwsion 要求使用 MySQL 5.0 以上版本的数据库支持, 您的服务器当前 MySQL 版本为: %s', $db->getServerVersion()), './');
		}
