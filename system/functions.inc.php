...
function _show_error($exception_message)
{
	...
	if ($exception_message)
	{
		...
		$errorBlock = "<div><textarea rows='15' onfocus='this.select()'>{$exception_message}</textarea></div>";
	}
